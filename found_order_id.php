...
include('header.php');
include('Config.php');
$res1 = $mcb->findOne(array('Order.order_id' => $_SESSION['order_id']));
$res2 = $mab->findOne(array('Order.order_id' => $_SESSION['order_id']));
$i=1;
?>
<!DOCTYPE html>
<html >
...
@keyframes unfold_bottom {
  ...
  <body translate="no" >
  <left>
 <form action=search_total_no.php method="post">
...
<right>
  ...
  <input type="text" name="search" >
  <input class="btn btn-info btn-lg" type="submit" value="Search"></label>
  <label>('To display all Orders By Date')</label>
 </form>
 </right>
  </div>
    <?php
...
<table >
<tr >
<th style="padding:0px 0px 0px 140px;">SR.NO</th>
<th style="padding:0px 0px 0px 85px;">Order ID</th>
<th style="padding:0px 0px 0px 110px;">Date</th>
<th style="padding:0px 0px 0px 120px;">Amount</th>
<th style="padding:0px 0px 0px 110px;">Status</th>
<th style="padding:0px 0px 0px 110px;">Print Bill</th>
</tr>
</table>
...
<div class="cards_wrapper">
  <div class="card folded today">
    <div class="card_description">
      ...
      {
        ?>
      <div class="title" style="padding:0px 40px;  " >Generate Invoice</div>
        <?php
      }
      ?>
