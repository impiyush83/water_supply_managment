...
{
echo "<script type='text/javascript'>alert('Cart is Empty'); window.location.href='register.php';</script>";}
else{
								...
								<div class="pay-tabs">
									<h2>Select Payment Method</h2>
									  <ul class="resp-tabs-list">
										  ...
										  <li class="resp-tab-item" aria-controls="tab_item-2" role="tab"><span><label class="pic4"></label>Cash On Delivery</span></li> 
								...
								<div class="resp-tabs-container">
									...
									<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-2">
										<div class="payment-info">
											...
											<h4>Pay your cash when the order is delivered</h4>
											<div class="login-tab">
												<div class="user-login">
													
													<form name="adrform" action="successful.php" method="post">
